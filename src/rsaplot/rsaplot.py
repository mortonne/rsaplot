...
def plot_dsm(dsm, rank=False, prange=(1, 99), vlim=None,
             color='viridis', ax=None):
...
def image_scatter(x, y, images, ax=None, zoom=1., frameon=False):
    ...
    for x0, y0, im, in zip(x, y, images):
        ...
        ab = AnnotationBbox(im0, (x0, y0), xycoords='data', frameon=frameon,
                            pad=0)
...
def plot_rep_as_dsm(data=None, distance='correlation', ax=None, prange=(1, 99),
                    color=None):
...
def plot_rep_as_mds(data=None, distance='correlation', ax=None,
                    images=None, color=None, zoom=1):
